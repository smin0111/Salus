...
public class PaymentService {
    ...
    public Payment verifyAndSavePayment(String impUid, String requestedMerchantUid, Long userId) {
        if (impUid == null || impUid.isBlank()) {
            throw new IllegalArgumentException("결제 고유번호가 누락되었습니다.");
        }
        if (requestedMerchantUid == null || requestedMerchantUid.isBlank()) {
        ...
        if (!requestedMerchantUid.equals(merchantUid)) {
